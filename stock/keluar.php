                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											<?php 
											$brg=sqlsrv_query($koneksi,"SELECT * FROM sbrg_keluar sb, sstock_brg st where st.idx=sb.idx ORDER BY id DESC");
											$no=1;
						...
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
									...
									<?php
									$det=sqlsrv_query($koneksi,"select * from sstock_brg order by nama ASC")or die(sqlsrv_error());
