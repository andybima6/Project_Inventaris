...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatdataskrg = sqlsrv_query($koneksi,"select * from sbrg_masuk where id='$id'"); //lihat qty saat ini
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											<?php 
											$brg= sqlsrv_query($koneksi,"SELECT * from sbrg_masuk sb, sstock_brg st where st.idx=sb.idx order by sb.id DESC");
											$no=1;
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="date" id="tanggal" name="tanggal" class="form-control" value="<?php echo $b['tgl']->format("YYYY-MM-DD") ?>">
						...
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									<?php
									$det= sqlsrv_query($koneksi,"select * from sstock_brg order by nama ASC");
