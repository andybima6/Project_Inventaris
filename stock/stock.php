...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            $periksa_bahan = sqlsrv_query($koneksi, "select * from sstock_brg where stock <1");
            while ($p = sqlsrv_fetch_array($periksa_bahan)) {
                if ($p['stock'] <= 1) {
            ?>
                    <script>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = sqlsrv_query($koneksi, "SELECT * from sstock_brg order by nama ASC");
                                            $no = 1;
                                            while ($p = sqlsrv_fetch_array($brgs)) {
                                                $idb = $p['idx'];
                                            ?>
