...
-- ENGINE=MyISAM: Menentukan jenis mesin penyimpanan tabel, di sini menggunakan mesin MyISAM. MyISAM dikenal karena kecepatan operasi pembacaan tinggi, namun tidak mendukung transaksi.

-- DEFAULT CHARSET=latin1: Menentukan karakter set default untuk tabel, di sini menggunakan karakter set Latin-1, yang mencakup karakter bahasa Eropa Barat.
